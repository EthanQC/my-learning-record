...
主要分为三个部分，整体架构重构、背诵 agent 完整开发、其他零碎边角料

整体架构重构：

* 重点关注技术选型与权衡
  * 为什么要做架构重构，重构后带来了什么好处
  * 为什么不使用现有的框架，比如 LangChain、LangGraph
  * 为什么是当前的这个方案，而不是其他的方案，有对比过其他实现方式吗

背诵 agent 完整开发：

* 在已有整理好的内容的基础上确认哪些是需要的，哪些是不需要的
* 确认简历上怎么写
* 确认可能的问题，并做针对性地回答准备
