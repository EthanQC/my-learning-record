...
胡乱记了两个月之后，我又发现还是要弄一个**方便自己翻阅**的笔记，所以才有了这个仓库现在的样子：**知识，碎碎念，还有一些反思总结**，既能看看自己来时的路，也能及时调整规划什么的

目前**还在建设中**，只是搭起来了大致的框架，后续会慢慢完善，我心中它最后的样子应该是一本能**快速索引**的字典，并且知识的记录能尽量**简洁易懂**，同时包含如何**实际应用**，当然，还要有一些**练习**
...
* 数据结构与算法 ⭐⭐⭐
    ...
    * 排序，回溯，贪心，动态规划等
* 数据库 ⭐⭐⭐
    * MySQL：~~索引优化、事务管理、存储引擎（如 InnoDB）和锁机制~~等，~~数据库设计与 SQL 调优~~
...
* 前端
    ...
    * [项目们](https://github.com/EthanQC/my-learning-record/blob/main/README.md#项目们)
* 后端
    * [网络库](https://github.com/EthanQC/my-learning-record/blob/main/README.md#网络库)
    * [项目们](https://github.com/EthanQC/my-learning-record/blob/main/README.md#项目们)
* [操作系统](https://github.com/EthanQC/my-learning-record/blob/main/README.md#操作系统)
* [计算机网络](https://github.com/EthanQC/my-learning-record/blob/main/README.md#计算机网络)
* 数据结构与算法
...
* [Git 和 GitHub](https://github.com/EthanQC/my-learning-record/blob/main/README.md#git-和-github)
* [设计模式](https://github.com/EthanQC/my-learning-record/blob/main/README.md#设计模式)
* [markdown](https://github.com/EthanQC/my-learning-record/blob/main/README.md#markdown)
* [leetcode](https://github.com/EthanQC/my-learning-record/blob/main/README.md#leetcode)
* [面试问题总结](https://github.com/EthanQC/my-learning-record/blob/main/README.md#面试问题总结)
...
[**`<数据库>`**](https://github.com/EthanQC/my-learning-record/blob/main/interview-questions/database.md)

[**`<操作系统>`**](https://github.com/EthanQC/my-learning-record/blob/main/interview-questions/operation-system.md)

[**`<计算机网络>`**](https://github.com/EthanQC/my-learning-record/blob/main/interview-questions/computer-network.md)
