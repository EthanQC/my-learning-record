...
+ **cpp、go、操作系统、计网、数据结构与算法、后端、前端**相关的知识点
+ 一些**小练习小项目**
+ 在学习过程中遇到的一些**问题/疑惑**
+ **碎碎念**（是的我的分享欲挺高的👉👈）
+ 我搜集到的各种**我认为好用**的学习资源
...
## 计划
中短期
* 4.26 已经跟 mentor 提了要 5.30 离职，mentor 说要到时候晚点再商量一下不用这么早决定
    * 无论他怎么挽留我五月底肯定都要走的
    * 准备到时候提前两周再提一次
* 目前简历已经初步改好，属于是能海投能拿大厂面试的水平，但准备专注于后端和 C++ 岗位了
    * go 简历项目要换一下，面后端岗位的时候这种游戏项目虽然也会深挖但感觉还是不如直接放两个业务项目上去
    * 实习经历还是要润色一下，多写点产出上去，要不然面试官都对这经历没兴趣
    * C++ 岗位需要再针对市场上目前的岗位重新修改一下
* 目前对要学的东西已经有较为清晰的认知，只是还需要规划一下
    * 五六月要冲刺式地做项目、刷算法和背八股
    * 六月开始边复习期末考边海投
    * 争取在期末考完前找到七月的实习无缝衔接，实在不行最晚七月份内要找到，或者沉淀到八月底追金九银十
...
* cpp
    ...
    * [特性](https://github.com/EthanQC/my-learning-record/blob/main/README.md#特性)
    * [性能分析与内存优化](https://github.com/EthanQC/my-learning-record/blob/main/README.md#性能分析与内存优化)
    * [并发与多线程编程](https://github.com/EthanQC/my-learning-record/blob/main/README.md#并发与多线程编程)
* go
    * [基础](https://github.com/EthanQC/my-learning-record/blob/main/README.md#基础)
    * [底层原理](https://github.com/EthanQC/my-learning-record/blob/main/README.md#底层原理)
    * [Gin](https://github.com/EthanQC/my-learning-record/blob/main/README.md#gin)
    * [GORM](https://github.com/EthanQC/my-learning-record/blob/main/README.md#GORM)
    * [gRPC](https://github.com/EthanQC/my-learning-record/blob/main/README.md#grpc)
    * [Protobuf](https://github.com/EthanQC/my-learning-record/blob/main/README.md#protobuf)
* 数据库
    * [MySQL](https://github.com/EthanQC/my-learning-record/blob/main/README.md#mysql)
    * [NoSQL](https://github.com/EthanQC/my-learning-record/blob/main/README.md#nosql)
    * [键值对存储原理](https://github.com/EthanQC/my-learning-record/blob/main/README.md#键值对存储原理)
    * [Redis](https://github.com/EthanQC/my-learning-record/blob/main/README.md#redis)
    * [Elasticsearch](https://github.com/EthanQC/my-learning-record/blob/main/README.md#elasticsearch)
* 数据结构与算法
...
* [Linux](https://github.com/EthanQC/my-learning-record/blob/main/README.md#linux)
* [Git](https://github.com/EthanQC/my-learning-record/blob/main/README.md#git)
* [设计模式](https://github.com/EthanQC/my-learning-record/blob/main/README.md#设计模式)
* [扩展和加分项](https://github.com/EthanQC/my-learning-record/blob/main/README.md#扩展和加分项)
* 前端
    * [HTML](https://github.com/EthanQC/my-learning-record/blob/main/README.md#html)
    * [CSS](https://github.com/EthanQC/my-learning-record/blob/main/README.md#css)
...
[**`<项目与实习>`**](https://github.com/EthanQC/my-learning-record/blob/main/interview-questions/projects-and-internships.md)
...
## Git
[**`<基础知识>`**](https://github.com/EthanQC/my-learning-record/blob/main/git/fundamentals.md)

[**`<常用操作>`**](https://github.com/EthanQC/my-learning-record/blob/main/git/common-operations.md)

## 设计模式
[**`<单例模式（待整理）>`**](https://github.com/EthanQC/my-learning-record/blob/main/design-mod/single-instance.md)

[**`<工厂模式（待整理）>`**](https://github.com/EthanQC/my-learning-record/blob/main/design-mod/factory.md)
...
**前端组件化、模块化以及常见的状态管理方案（Redux / Vuex 等），性能优化（待整理）**
**Node.js、jQuery 等常见框架或库，相应的扩展编写（待整理）**
...
[**`<我现在正在尝试参加的开源活动（待整理）>`**](https://github.com/EthanQC/my-learning-record/blob/main/join-in-open-source/open-source-events-that-I'm-trying-to-engage.md)

## 其他
[**`<操作系统基础概念>`**](https://github.com/EthanQC/my-learning-record/blob/main/other/os-fundamentals.md)

[**`<Markdown 基础语法>`**](https://github.com/EthanQC/my-learning-record/blob/main/other/md-grammars.md)

## 碎碎念和反思总结
>[**2024.10.24**](https://github.com/EthanQC/my-learning-record/blob/main/murmurs-and-reflection/2024.10.24.md)
>
>[**2024.10.25**](https://github.com/EthanQC/my-learning-record/blob/main/murmurs-and-reflection/2024.10.25.md)
>
...
>
>[**2024.10.28**](https://github.com/EthanQC/my-learning-record/blob/main/murmurs-and-reflection/2024.10.28.md)
>
...
>
>[**2025.2.3**](https://github.com/EthanQC/my-learning-record/blob/main/murmurs-and-reflection/2025.2.3.md)
>
>[**2025.2.11**](https://github.com/EthanQC/my-learning-record/blob/main/murmurs-and-reflection/2025.2.11.md)
>
...
>
>[**2025.3.22**](https://github.com/EthanQC/my-learning-record/blob/main/murmurs-and-reflection/2025.3.22.md)
>
>[**2025.3.23**](https://github.com/EthanQC/my-learning-record/blob/main/murmurs-and-reflection/2025.3.23.md)
>
...
>
>[**2025.5.7**](https://github.com/EthanQC/my-learning-record/blob/main/murmurs-and-reflection/2025.5.7.md)
>
>[**2025.5.30**](https://github.com/EthanQC/my-learning-record/blob/main/murmurs-and-reflection/2025.5.30.md)

## 我的其他仓库
>[基于异步日志系统的 HTTP 框架](https://github.com/EthanQC/HTTP-framework-based-on-asynchronous-logging-system)
>
>[Raft-KV 存储](https://github.com/EthanQC/Raft-KV-Storage)
>
>[即时通讯 IM](https://github.com/EthanQC/IM)
>
