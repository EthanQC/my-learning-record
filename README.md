...
**每次学习完，哪怕只用10分钟，也稍微写一点自己对知识点的简单理解或关键注意点**
...
* 找新实习准备
    ...
    * 八股
        ...
        * 设计模式：发现自己 cpp 大量遗忘
    * 改简历：基本改完
    * 海投：只是稍微投了一点点，有一家 cpp 的初面还没有填网申资料
* 项目
    * cpp
        * HTTP 服务框架：还没开始看，只是克隆了
        * 分布式存储：还没开始看，只是克隆了
    * **游戏：月华**
        * 单机版：处于新建文件夹阶段，卡在学习虚幻五上
            * 虚幻五的 2d 或二渲三
            * cpp
        * 联机版：前端技术组件不太会，go基础还没学完，卡在 UI 设计和具体模块实现
            * go 后端服务器
            * 虚幻五内置联机功能
            * 虚幻五前端 UI 或 React 等 Web 前端组件
    * go
        * 月华的后端服务器
        * IM：还没开始看，只是克隆了
    * 清华人机交互实验室游戏项目：暂时未有实际开发需求推进，论文还没看，卡在学习虚幻五上
