...
export default async function InterviewExperiencesPage() {
  ...
  const posts = allPosts.filter(post => 
    post.slug.includes('interview-experiences') || post.category === 'interview-experiences'
  );
    ...
    <div className="container mx-auto max-w-4xl px-4 sm:px-6 py-8 sm:py-12">
      ...
      <nav className="mb-6 text-sm">
        <ol className="flex items-center gap-2 text-gray-500">
          ...
          <li>/</li>
          <li className="text-gray-800 font-medium">面经分享</li>
        </ol>
      </nav>
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-500">真实面试经历与经验总结</p>
      ...
      {posts.length === 0 ? (
        <Card className="text-center py-12">
          <p className="text-gray-500">暂无面经文章</p>
        </Card>
      ) : (
